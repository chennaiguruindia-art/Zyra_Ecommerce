                ...
                <div class="seller-card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control seller-form-control" value="Ananya Boutique & Handlooms" required>
                        </div>
                        <div class="col-md-6">
                            <label class="seller-form-label">Display Slug</label>
                            <input type="text" class="form-control seller-form-control" value="ananya-boutique" readonly>
                        </div>
                        <div class="col-md-6">
                            <label class="seller-form-label">Business Email *</label>
                            <input type="email" class="form-control seller-form-control" value="ananya@boutiquefashion.in" required>
                        </div>
                        <div class="col-md-6">
                            <label class="seller-form-label">Contact Phone *</label>
                            <input type="tel" class="form-control seller-form-control" value="9876543210" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="seller-card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control seller-form-control" value="Shed 14, Textile Industrial Area, Ring Road" required>
                        </div>
                        <div class="col-md-4">
                            <label class="seller-form-label">City *</label>
                            <input type="text" class="form-control seller-form-control" value="Jaipur" required>
                        </div>
                        <div class="col-md-4">
                            <label class="seller-form-label">State *</label>
                            <input type="text" class="form-control seller-form-control" value="Rajasthan" required>
                        </div>
                        <div class="col-md-4">
                            <label class="seller-form-label">PIN Code *</label>
                            <input type="text" class="form-control seller-form-control" value="302001" maxlength="6" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="seller-card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control seller-form-control" value="HDFC Bank" required>
                        </div>
                        <div class="col-md-6">
                            <label class="seller-form-label">Beneficiary Account Name *</label>
                            <input type="text" class="form-control seller-form-control" value="Ananya Fashion Works Pvt Ltd" required>
                        </div>
                        <div class="col-md-6">
                            <label class="seller-form-label">Account Number *</label>
                            <input type="password" class="form-control seller-form-control" value="50200084920194" required>
                        </div>
                        <div class="col-md-6">
                            <label class="seller-form-label">IFSC Code *</label>
                            <input type="text" class="form-control seller-form-control" value="HDFC0001234" required>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="seller-card">
                ...
                <div class="seller-card-body small">
                    <div class="mb-2">
                        <span class="text-muted">GSTIN:</span> <strong>08AAAAA0000A1Z5</strong>
                    </div>
                    <div class="mb-2">
