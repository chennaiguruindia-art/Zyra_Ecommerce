...
@section('title', 'Edit Product | ZYRA Seller Hub')
@section('meta_description', 'Update product details and stock.')
...
<div class="seller-page-header">
    <div>
        ...
        <p class="text-muted mb-0">Modify information, price and inventory for this item.</p>
    </div>
...
<form id="sellerEditProductForm" method="POST" action="{{ route('seller.products.update', $productId) }}" enctype="multipart/form-data" novalidate>
    ...
    <div class="row g-4">
            ...
            <div class="seller-card mb-4">
                ...
                <div class="seller-card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="productNameInput" class="form-control seller-form-control" required>
                    </div>
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label for="productSubcategoryInput" class="seller-form-label">Subcategory</label>
                            <input type="text" id="productSubcategoryInput" class="form-control seller-form-control">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="productDescriptionInput" class="seller-form-label">Product Description</label>
                        <textarea id="productDescriptionInput" rows="4" class="form-control seller-form-control"></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="productMaterialInput" class="seller-form-label">Fabric & Material</label>
                        <input type="text" id="productMaterialInput" class="form-control seller-form-control">
                    </div>
                </div>
            </div>
                ...
                <div class="seller-card-body">
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" id="productPriceInput" class="form-control seller-form-control" required>
                        </div>
                        <div class="col-md-4">
                            <label for="productOldPriceInput" class="seller-form-label">Original / MRP (₹)</label>
                            <input type="number" id="productOldPriceInput" class="form-control seller-form-control">
                        </div>
                        <div class="col-md-4">
        ...
        <!-- Right: Image Media (Max 4 Images) & Actions -->
        <div class="col-lg-4">
