...
@section('title', 'Privacy Policy | ZYRA Lifestyle')
@section('meta_description', 'Read the ZYRA Lifestyle Privacy Policy to understand how we collect, use, disclose, and protect your personal information when you visit, use, or make a purchase using our Services.')
...
<x-breadcrumb :items="[['label' => 'Privacy Policy', 'url' => '']]" />

<div class="container py-5">

    <div class="row mb-5 text-center">
        <div class="col-lg-8 mx-auto">
            <span class="text-uppercase small fw-bold text-muted">Legal & Compliance</span>
            <h1 class="display-6 fw-bold mt-1 mb-2">Privacy Policy</h1>
            <p class="text-muted">Last updated: August 21, 2026</p>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            ...
            <div class="zyra-legal-intro p-4 bg-light rounded-4 mb-4">
                <p class="mb-0 small text-muted">
                    ZyraLifestyle operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). ZyraLifestyle is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
                </p>
                <p class="mb-0 mt-3 small fw-semibold">
                    Please read this Privacy Policy carefully. By using and accessing any of the Services, you acknowledge that you have read this Privacy Policy and understand the collection, use, and disclosure of your information as described in this Privacy Policy.
                </p>
            </div>

            <div class="zyra-legal-content">

                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">Personal Information We Collect or Process</h2>
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">Personal Information Sources</h2>
                    <p class="text-muted small">We may collect personal information from the following sources:</p>
                    <ul class="zyra-legal-list">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">How We Use Your Personal Information</h2>
                    <p class="text-muted small">Depending on how you interact with us or which of the Services you use, we may use personal information for the following purposes:</p>
                    <ul class="zyra-legal-list">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">How We Disclose Personal Information</h2>
                    <p class="text-muted small">In certain circumstances, we may disclose your personal information to third parties for legitimate purposes subject to this Privacy Policy. Such circumstances may include:</p>
                    <ul class="zyra-legal-list">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">Children's Data</h2>
                    <p class="text-muted small">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">Security and Retention of Your Information</h2>
                    <p class="text-muted small">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">Your Rights and Choices</h2>
                    <p class="text-muted small">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">Complaints</h2>
                    <p class="text-muted small">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">International Transfers</h2>
                    <p class="text-muted small">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">Changes to This Privacy Policy</h2>
                    <p class="text-muted small">
                ...
                <section class="zyra-legal-section">
                    <h2 class="zyra-legal-heading">Contact</h2>
                    <p class="text-muted small">
                        Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call <a href="tel:+919884125555">+91 988 412 5555</a> or email us at <a href="mailto:order@shopwithzyra.in">order@shopwithzyra.in</a> or contact us at No F 200, F Block, 1<sup>st</sup> Street, Annanagar East, No F 200, F Block, 1<sup>st</sup> Street, Annanagar East, 600102 Chennai TN, India.
                    </p>
                </section>
            ...
            <div class="p-4 bg-light rounded-4 text-center mt-5">
                <h5 class="fw-bold mb-2">Questions About Your Privacy?</h5>
                <p class="text-muted small mb-3">Our team is available to help you with any privacy-related queries.</p>
                <div class="d-flex justify-content-center gap-2">
                    <a href="{{ route('contact') }}" class="btn btn-sm btn-zyra-primary">Contact Us</a>
